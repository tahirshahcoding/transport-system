      ...
      >
        ...
        <div className="space-y-2 mb-4 text-[16px]">
          <div className="flex justify-between items-baseline border-b border-dotted border-black pb-1">
            ...
            <span className="font-mono font-bold">{displayReceiptNo}</span>
          </div>
          <div className="flex justify-between items-baseline border-b border-dotted border-black pb-1">
          ...
          <div className="flex justify-between items-baseline border-b border-dotted border-black pb-1">
            ...
            <span className="font-black text-[17px] truncate max-w-[200px]">{studentName}</span>
          </div>

          <div className="flex justify-between items-baseline border-b border-dotted border-black pb-1">
            <span className="font-bold min-w-[110px]">Class / Grade :</span>
            <span className="font-bold truncate max-w-[200px]">{displayClass}</span>
          </div>

          <div className="flex justify-between items-baseline border-b border-dotted border-black pb-1">
            <span className="font-bold min-w-[110px]">Route / Stop :</span>
            <span className="font-bold truncate max-w-[200px]">{route}</span>
          </div>
          ...
          <div className="flex justify-between items-baseline border-b border-dotted border-black pb-1">
            <span className="font-bold min-w-[110px]">Monthly Fee :</span>
            <span className="font-bold">Rs. {fee.toLocaleString()}</span>
          </div>
          ...
          <div className="flex justify-between items-baseline border-b-2 border-black pb-1 pt-1.5">
            <span className="font-black text-[18px]">Total Amount (PKR) :</span>
            <span className="font-black text-[20px]">Rs. {totalAmount.toLocaleString()}</span>
          </div>
        </div>
        ...
        <div className="border-2 border-black rounded-sm p-3 my-4">
          ...
          <ol className="list-decimal list-inside text-[14px] leading-snug space-y-1 font-bold">
